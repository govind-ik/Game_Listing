...
const Genrelist = () => {
  ...
  return (
    <div >
      ...
      {genremp.map((resp,index)=>(
        <div onClick={()=> setActiveindex(index)} className={`flex gap-2 items-centre hover:bg-gray-300 rounded-2xl group  mb-1  cursor-pointer ${activeindex===index?'bg-gray-300':null} `}>
